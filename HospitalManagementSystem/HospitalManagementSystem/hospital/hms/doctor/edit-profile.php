...
<html lang="en">
	<head>
		<title>Doctr | Editimi Profilit Tim </title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor | Editimi Profilit Tim</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor</span>
									...
									<li class="active">
										<span>Editimi Profilit Tim</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editimi Profilit Tim</h5>
												</div>
