...
if($sql)
{
echo "<script>alert('Të dhënat e Pacientit janë Regjistruar me sukses!..');</script>";
...
<html lang="en">
	<head>
		<title>Doctor | Regjistro një Pacient  </title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Pacientët | Shto Pacientët </h1>
</div>
<ol class="breadcrumb">
<li>
<span>Pacientet</span>
...
<h5 class="panel-title">Shto Pacientet</h5>
</div>
